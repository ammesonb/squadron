...
[Squadron](/) is a declarative agent framework: agents, tools, models, missions, budgets, and routing are HCL config, while operational state such as schedules and access control is managed by the Squadron product.
...
- [The Harness](/config/missions/harness) — the runtime model behind Squadron's declarative workflows
- [Missions overview](/config/missions/overview) — every block, every field
