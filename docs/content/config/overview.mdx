...
Configuration pages document the HCL contract: what you can declare and how Squadron evaluates it. For workspace setup, identity management, access control, and operating mission runs, see the [Squadron Product](/product/overview) documentation.
...
3. **Model providers** - Resolve `model_provider` allow-lists against Command Center connections
...
| `model_provider` | Allow models from a Command Center connection |
