...
[shared Squadron deployment](/config/command_center).
...
| `command_center` | Pushes the notification to the [Squadron product](/config/command_center). No-ops when no shared deployment is connected. |
