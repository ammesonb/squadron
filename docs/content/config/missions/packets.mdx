...
Packets are the read-only counterpart to [memory and scratchpad slots](/config/missions/folders). Memory slots are writable workspaces with Squadron-managed paths; packets point at *user-controlled* directories and are immutable to agents.
