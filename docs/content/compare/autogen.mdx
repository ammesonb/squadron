...
- **Operational maturity.** Resume, schedules, webhooks, budgets, and a web product are all first-class.
...
- [What is Squadron?](/)
- [Routing](/config/missions/routing) — how Squadron handles dynamic decisions
